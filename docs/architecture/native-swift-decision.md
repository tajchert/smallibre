...
Accepted 2026-09-08: native Swift/SwiftUI/AppKit, custom focused book processing, no Python, Qt or Rust runtime. This supersedes the worker/portable-core recommendation in the original design proposal. The Calibre checkout is reference material and is excluded from Nova git history.
