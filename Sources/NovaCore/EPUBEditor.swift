    ...
    static func prepare(_ epub: EPUBBook, metadata: BookMetadata, typography: TypographySettings) throws -> Data {
        ...
        if typography.enabled {
            ...
            for path in epub.chapters {
                ...
                for node in try head.nodes(forXPath: "./*[local-name()='style'][@id='nova-typography']") { node.detach() }
                ...
                style.addAttribute(XMLNode.attribute(withName: "id", stringValue: "nova-typography") as! XMLNode)
