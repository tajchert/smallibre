...
private struct DeviceMetadataView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            ...
            Text("Smallibre backs up the original on your Mac, updates metadata and verifies the device copy. Book content is preserved. Eject Kindle to let it refresh its index.").font(.callout).foregroundStyle(.secondary)
            HStack {
