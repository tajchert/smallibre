...
final class PreviewTests: XCTestCase {
    func testOnlySanitizedLocalHTMLMayBecomeAPreviewDocument() {
        XCTAssertTrue(PreviewSanitizer.allowsNavigation(URL(string: "smallibre-book://book/EPUB/chapter.xhtml")!))
        XCTAssertFalse(PreviewSanitizer.allowsNavigation(URL(string: "smallibre-book://book/EPUB/image.svg")!))
